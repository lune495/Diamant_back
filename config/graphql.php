    ...
    'schemas' => [
        'default' => [
            'query' => [
                ...
                \App\GraphQL\Query\PatientQuery::class,
                \App\GraphQL\Query\VenteProduitsQuery::class,
                \App\GraphQL\Query\RolePaginatedQuery::class,
                \App\GraphQL\Query\MedecinPaginatedQuery::class,
                \App\GraphQL\Query\DepensePaginatedQuery::class,
                \App\GraphQL\Query\UserQuery::class,
                \App\GraphQL\Query\RoleQuery::class,
                \App\GraphQL\Query\LogQuery::class,
                \App\GraphQL\Query\UserQuery::class,
                \App\GraphQL\Query\MedecinQuery::class,
                \App\GraphQL\Query\ClotureCaisseQuery::class,
                \App\GraphQL\Query\ClotureCaissePaginatedQuery::class,
                \App\GraphQL\Query\DepenseQuery::class,
                \App\GraphQL\Query\ModulePaginatedQuery::class,
                \App\GraphQL\Query\ModuleQuery::class,
                \App\GraphQL\Query\TypeServicePaginatedQuery::class,
                \App\GraphQL\Query\TypeServiceQuery::class,
                \App\GraphQL\Query\ServicePaginatedQuery::class,
                \App\GraphQL\Query\ServiceQuery::class,
                \App\GraphQL\Query\DossierQuery::class,
            ...
            'types' => [
                ...
                \App\GraphQL\Type\PatientType::class,
                \App\GraphQL\Type\DossierType::class,
                ...
                \App\GraphQL\Type\MedecinType::class,
                \App\GraphQL\Type\LogType::class,
                \App\GraphQL\Type\UserType::class,
                \App\GraphQL\Type\MedecinPaginatedType::class,
                \App\GraphQL\Type\UserPaginatedType::class,
                \App\GraphQL\Type\ModulePaginatedType::class,
                \App\GraphQL\Type\TypeServicePaginatedType::class,
                \App\GraphQL\Type\TypeServiceType::class,
                \App\GraphQL\Type\ModuleType::class,
                \App\GraphQL\Type\ServicePaginatedType::class,
                \App\GraphQL\Type\ServiceType::class,
                \App\GraphQL\Type\ElementServicePaginatedType::class,
                \App\GraphQL\Type\ElementServiceType::class,
                \App\GraphQL\Type\MedecinPaginatedType::class,
                \App\GraphQL\Type\DepensePaginatedType::class,
                \App\GraphQL\Type\MedecinType::class,
                \App\GraphQL\Type\DepenseType::class,
                \App\GraphQL\Type\ClotureCaisseType::class,
                \App\GraphQL\Type\ClotureCaissePaginatedType::class,
